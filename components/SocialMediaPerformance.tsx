...
const SocialMediaPerformance = () => {
  ...
  const allData = [
    { platform: "Instagram", category: "Carousel", likes: 4521, shares: 132, comments: 204 },
    { platform: "Facebook", category: "Reels", likes: 8923, shares: 523, comments: 742 },
    { platform: "LinkedIn", category: "Static Images", likes: 3478, shares: 87, comments: 156 },
    { platform: "Instagram", category: "Stories", likes: 2500, shares: 50, comments: 100 },
    { platform: "Facebook", category: "Videos", likes: 4000, shares: 200, comments: 300 },
    { platform: "LinkedIn", category: "Polls", likes: 1500, shares: 20, comments: 50 },
    { platform: "Instagram", category: "Live Streams", likes: 5200, shares: 300, comments: 400 },
  ];
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-4 w-full sm:w-auto">
              <div className="text-[10px] font-mono text-black/40 dark:text-white/40 flex items-center gap-2">
                ...
                Social Media Performance Analysis | 2025
              </div>
